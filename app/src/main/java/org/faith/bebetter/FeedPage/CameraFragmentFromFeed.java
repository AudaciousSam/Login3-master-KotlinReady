...
import org.faith.bebetter.NotifsPage.ImagePreviewFromNotification;
 ...
 */
public class CameraFragmentFromFeed extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback{

    public CameraFragmentFromFeed() {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (cameraState == 1){
                CropImage.activity(imageUri)
                        ...
                        .setAspectRatio(1,2)
                        .start(getContext(), CameraFragmentFromFeed.this);
            } else {
                CropImage.activity(imageUri)
                        .setGuidelines(CropImageView.Guidelines.ON)
                        .setAspectRatio(1,2)
    ...
    public static CameraFragmentFromFeed newInstance() {
        return new CameraFragmentFromFeed();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //get experienceKey!
        experienceKey = getArguments().getString("EXTRA_KEY");

        //The userkey from the experience invite sender.
        //inviteFrom = getArguments().getString("EXTRA_FROM");
    ...
    /**
     * Opens the camera specified by {@link CameraFragmentFromFeed#mCameraId}.
     */
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Intent intent = new Intent(getActivity(), ImagePreviewFromNotification.class);
                Bundle extras = new Bundle();
                extras.putString("EXTRA_KEY", experienceKey);
                //extras.putString("EXTRA_IMAGENAME", currentUserId);
                extras.putString("EXTRA_URI", resultUri.toString());
                //extras.putString("EXTRA_FROM", inviteFrom);
